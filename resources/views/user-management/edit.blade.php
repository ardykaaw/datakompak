                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                <label for="password" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                    Password <span class="text-sm text-gray-500">(Kosongkan jika tidak ingin mengubah password)</span>
                                </label>
                                <div class="mt-1">
                                    <input type="password" 
                                           name="password" 
                                ...
                                <div class="mt-1">
                                    <select name="unit" 
                                        ...
                                        @foreach($units as $unit)
                                            <option value="{{ $unit->id }}" {{ old('unit', $user->unit_id) == $unit->id ? 'selected' : '' }}>
                                                {{ $unit->name }}
                                            </option>
                                        @endforeach
                                    </select>
