...
<div class="min-h-screen flex items-center justify-center bg-cover bg-center" style="background-image: url('{{ url('images/powerplant.jpeg') }}');">
    ...
    <div class="max-w-5xl w-full bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl relative">
        <div class="grid grid-cols-2">
            <!-- Left Side - Logo and Title -->
            <div class="p-10 flex flex-col justify-center items-center border-r border-gray-200">
                <div class="space-y-3">
            ...
            <div class="p-10">
                <h3 class="text-2xl font-semibold text-gray-800 mb-6">Login to Your Account</h3>
                        ...
                        <div class="group">
                            ...
                            <div class="flex items-center bg-gray-50 rounded-lg border-2 border-gray-200 group-hover:border-blue-500 transition-all duration-300">
                                ...
                                <input id="email" name="email" type="email" required 
                                    class="block w-full px-4 py-3 bg-gray-50 border-0 focus:ring-0 focus:outline-none rounded-r-lg text-gray-900 placeholder-gray-400" 
